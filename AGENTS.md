...
Статус: **Этапы 0–10 выполнены** (справочник + план в `docs/mep/`; миграция единиц дюймы→мм + ГОСТ-ряд,
...
Следующий — Этапы 11–13 (верификация норм `TABLE_L3_VERIFIED`/`MOUNTING_SPACING_VERIFIED`/
`FITTING_ZETA_VERIFIED`, сквозная регрессия, публикация в форк).
