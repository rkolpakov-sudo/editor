...
Статус: **Этапы 0–11 выполнены** (справочник + план в `docs/mep/`; миграция единиц дюймы→мм + ГОСТ-ряд,
...
итог `bun test` — **3227 pass / 1 skip / 0 fail**).
Следующий — Этапы 12–13 (сквозная регрессия, публикация в форк).
