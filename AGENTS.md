...
Следующий — Этап 13 (публикация в форк: ветка `feat/mep-network`) и **агент автотрассировки**
(утверждённый план `docs/mep/PLAN-AGENT.md`: эскиз П/В полилиниями → кнопка «Трассировка» →
сеть по нормам; контекстное меню типа помещения; высоты «как в Revit» — ось на вершинах,
авто-вертикали; рекомендации оборудования; баланс П/В; митигации W1–W13 внутри плана).
