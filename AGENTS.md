...
выявлено: duct-инструмент авто-сливает пересекающиеся трассы крестовиной (авто-фиттинг) — для утки
трассы должны быть на разных отметках или сети разделены вручную;
итог `bun test` — **3228 pass / 1 skip / 0 fail**).
