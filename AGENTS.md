...
Статус: **Этапы 0–1 выполнены** (справочник + план в `docs/mep/`; миграция единиц дюймы→мм + ГОСТ-ряд,
коммиты `19224724`, `7f1aede5`, `31a7060f`). Следующий — Этап 2 (авто-зоны помещений). Архитектурно-чувствительные
