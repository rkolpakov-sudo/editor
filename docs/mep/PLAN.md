...
Статус агента: **этапы A1–A3, B1–B5 и C1–C3 выполнены** (эскизный узел, режим «Эскиз»,
...
оборудования, автоответвления; 3340 тестов зелёные); следующий — C4 (отметки в DXF/
спецификации) и Этап D (сквозная регрессия).
