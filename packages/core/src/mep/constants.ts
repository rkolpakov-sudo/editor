...
/** Вертикальные металлические воздуховоды — не более 4,5 м между опорами
 *  (СП 73.13330.2016 п. 6.5.7; внутри многоэтажных корпусов с высотой этажа
 *  до 4,5 м крепление в междуэтажных перекрытиях). */
export const VERTICAL_MOUNTING_SPACING_M = 4.5
